...
public function render()
    {
        ...
        $performance = LOANAPPLICATION::where(DB::raw('date(APPLICATION_DATE)'), '>=', date('Y')."-01-01")->select(DB::raw('count(*) as count'), 'TRANSACTION_STATUS')->groupBy('TRANSACTION_STATUS')->get()->toArray();

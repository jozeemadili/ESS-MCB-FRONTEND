                  ...
                  @if($message = Session::get('success'))
					...
					@endif
                      ...
                      <div class="table-responsive">
						...
						<table class="table table-xs">
							...
							<tbody>
								...
								<tr>
                                    ...
                                    <td><a href='{{url()->current()}}/profile/{{$vehicle->id}}'><small>{{strtoupper(explode(' ',$vehicle->owner_name)[0] .' '. (explode(' ',$vehicle->owner_name)[count(explode(' ',$vehicle->owner_name))-1]))}}</small></a></td>
									<td><a href='{{url()->current()}}/profile/{{$vehicle->id}}'>{{$vehicle->registration_number}}</a></td>
                                    <td><a href='{{url()->current()}}/profile/{{$vehicle->id}}'>{{$vehicle->chassis_number}}</a></td>
                                    <td>{{$vehicle->make}}</td>
                                    <td>{{$vehicle->model}}</td>
                                    <td>{{$vehicle->body_type}}</td>
                                    <td>{{number_format($vehicle->engine_capacity, 0, '.',',')}}</td>
                        ...
                        <div class="alert alert-danger outline alert-dismissible fade show" role="alert">
                            <i class="icon-info-alt txt-danger"></i>
								No Vehicle Records created by you Found yet

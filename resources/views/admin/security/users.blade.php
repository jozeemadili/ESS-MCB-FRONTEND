						...
						<table class="table table-xs">
							...
							<tbody>
								...
								<tr>
									...
									<td><a href=""><small>{{strtoupper($user->first_name)}}</small></a></td>
                                    ...
                                    <div class="pull-left"> <a href='{!! Route('user-status-update', ['id' => $user->id, 'status' => 'Inactive']) !!}' class='btn btn-outline-danger btn-xs'>Deactivate <i class="icofont icofont-ui-delete"></i></a></div>  
                                    <div class="pull-left"> <a href='{!! Route('security-user-resert_password', ['id' => $user->id]) !!}' class='btn btn-outline-primary btn-xs'>Resert <i class="icofont icofont-ui-delete"></i></a></div>
			
                                    @else
                                    <div class="pull-left"> <a href='{!! Route('user-status-update', ['id' => $user->id, 'status' => 'Active']) !!}' class='btn btn-outline-info btn-xs'>Activate <i class="icofont icofont-ui-delete"></i></a></div>  
                                    @endif
                        ...
                        <div class="col-lg-4">
                            ...
                            <label class="col-form-label" >Select Mwalimu Bank Branch</label>
                                ...
                                <option value="">--- Choose Branch ---</option>  
                                        @foreach ($distinctBranchCodes as $branch)
                                    <option value='{{strtoupper($branch->BRANCH_CODE)}}'>{{strtoupper($branch->BRANCH_NAME)}} ({{strtoupper($branch->BRANCH_CODE)}})</option>
                                    @endforeach
								</select>
                            </div>

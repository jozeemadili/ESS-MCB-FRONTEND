<div class="page-main-header">
  <div class="main-header-right row m-0">
    ...
    <a href="{{ route('home') }}">
        <img class="img-fluid" src="{{asset('assets/images/logo/mwalimu2.png')}}" alt="" style="width: 120px; height: 50px;">
    </a>
</div>
      <div class="dark-logo-wrapper"><a href="{{ route('home') }}"><img class="img-fluid" src="{{asset('assets/images/logo/pep.png')}}" alt=""></a></div>

          ...
          <div class="col-sm-12">
              <div class="card">
                  <div class="card-header pb-0">
                      ...
                      <span>Several System Configurations and Settings will be Available here ...</span>
                  </div>
                  <div class="card-body">
                      <p>
                      </p>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/security/configurations.blade.php ENDPATH**/ ?>
                  ...
                  <?php if($message = Session::get('success')): ?>
					...
					<?php endif; ?>
                      ...
                      <table class="table table-xs">
                        ...
                        <td><?php echo e(App\Http\Controllers\API\Auth\CustomersController::resolveIdCustomerName($p->LOAN_NUMBER)); ?></td>
                            ...
                            <td>
                                <?php if(!empty($p->PAYMENT_ADVICE)): ?>
                                    <button 
                                        class="btn btn-outline-primary btn-xs"
                                        data-bs-toggle="modal"
                                        data-bs-target="#pdfPreviewModal"
                                        onclick="showPDFInModal(`<?php echo e($p->PAYMENT_ADVICE); ?>`)">
                                        Preview
                                    </button>
                                <?php else: ?>
                            ...
                            <td>
                            <td>
                              <a href="<?php echo e(Route('incoming-payament-profile', ['loan_id' => $p->LOAN_NUMBER])); ?>"  class="btn btn-outline-primary btn-xs" >Details</a>
                            </td>
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/josephatwilliammadili/Desktop/UPDATED PROJECTS/EXTERNAL/MCB ESS/FRONT END/ESS-MCB-FRONTEND/resources/views/admin/loan_take_over/incoming_payment_request.blade.php ENDPATH**/ ?>
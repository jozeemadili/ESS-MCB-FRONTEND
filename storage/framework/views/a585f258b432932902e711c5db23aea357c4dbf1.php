...
} elseif ($_instance->childHasBeenRendered('v5JwoVo')) {
    $componentId = $_instance->getRenderedChildComponentId('v5JwoVo');
    $componentTag = $_instance->getRenderedChildComponentTagName('v5JwoVo');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('v5JwoVo');
} else {
    $response = \Livewire\Livewire::mount('components.vehicle.details', ['vehicle' => $vehicle, 'approval_datils' => $approval_datils]);
    $html = $response->html();
    $_instance->logRenderedChild('v5JwoVo', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?></p>
                        </div>
  ...
  <?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/properties/staff-profile.blade.php ENDPATH**/ ?>
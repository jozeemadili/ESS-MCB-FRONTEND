<?php $__env->startSection('title'); ?>Search Website
 <?php echo e($title); ?>
	                                ...
	                                <div class="col-xl-6 box-col-6 search-banner">
	                                    <div class="card">
	                                        <div class="blog-box blog-shadow">
	                                            <img class="img-fluid bg-img-cover" src="<?php echo e(asset('assets/images/blog/blog.jpg')); ?>" alt="" />
	                            ...
	                            <div class="info-block m-t-30">
	                                ...
	                                <div class="my-gallery row gallery-with-description" id="aniimated-thumbnials" itemscope="">
	                                    <figure class="col-xl-3 col-sm-6" itemprop="associatedMedia" itemscope="">
	                                        <a href="<?php echo e(asset('assets/images/big-lightgallry/01.jpg')); ?>" itemprop="contentUrl" data-size="1600x950">
	                                            <img src="<?php echo e(asset('assets/images/lightgallry/01.jpg')); ?>" itemprop="thumbnail" alt="Image description" />
	                                            <div class="caption">
	                                    ...
	                                    <figure class="col-xl-3 col-sm-6" itemprop="associatedMedia" itemscope="">
	                                        <a href="<?php echo e(asset('assets/images/big-lightgallry/02.jpg')); ?>" itemprop="contentUrl" data-size="1600x950">
	                                            <img src="<?php echo e(asset('assets/images/lightgallry/02.jpg')); ?>" itemprop="thumbnail" alt="Image description" />
	                                            <div class="caption">
	                                                <h4>Portfolio Title</h4>
	                                                <p>is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy.</p>
	                                            </div>
	                                    ...
	                                    <figure class="col-xl-3 col-sm-6" itemprop="associatedMedia" itemscope="">
	                                        <a href="<?php echo e(asset('assets/images/big-lightgallry/03.jpg')); ?>" itemprop="contentUrl" data-size="1600x950">
	                                            <img src="<?php echo e(asset('assets/images/lightgallry/03.jpg')); ?>" itemprop="thumbnail" alt="Image description" />
	                                            <div class="caption">
	                                                <h4>Portfolio Title</h4>
	                                                <p>is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy.</p>
	                                            </div>
	                                    ...
	                                    <figure class="col-xl-3 col-sm-6" itemprop="associatedMedia" itemscope="">
	                                        <a href="<?php echo e(asset('assets/images/big-lightgallry/04.jpg')); ?>" itemprop="contentUrl" data-size="1600x950">
	                                            <img src="<?php echo e(asset('assets/images/lightgallry/04.jpg')); ?>" itemprop="thumbnail" alt="Image description" />
	                                            <div class="caption">
	                                                <h4>Portfolio Title</h4>
	                                                <p>is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy.</p>
	                                            </div>
	                                    ...
	                                    <figure class="col-xl-3 col-sm-6" itemprop="associatedMedia" itemscope="">
	                                        <a href="<?php echo e(asset('assets/images/big-lightgallry/05.jpg')); ?>" itemprop="contentUrl" data-size="1600x950">
	                                            <img src="<?php echo e(asset('assets/images/lightgallry/05.jpg')); ?>" itemprop="thumbnail" alt="Image description" />
	                                            <div class="caption">
	                                                <h4>Portfolio Title</h4>
	                                                <p>is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy.</p>
	                                            </div>
	                                    ...
	                                    <figure class="col-xl-3 col-sm-6" itemprop="associatedMedia" itemscope="">
	                                        <a href="<?php echo e(asset('assets/images/big-lightgallry/011.jpg')); ?>" itemprop="contentUrl" data-size="1600x950">
	                                            <img src="<?php echo e(asset('assets/images/lightgallry/011.jpg')); ?>" itemprop="thumbnail" alt="Image description" />
	                                            <div class="caption">
	                                                <h4>Portfolio Title</h4>
	                                                <p>is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy.</p>
	                                            </div>
	                                    ...
	                                    <figure class="col-xl-3 col-sm-6" itemprop="associatedMedia" itemscope="">
	                                        <a href="<?php echo e(asset('assets/images/big-lightgallry/010.jpg')); ?>" itemprop="contentUrl" data-size="1600x950">
	                                            <img src="<?php echo e(asset('assets/images/lightgallry/010.jpg')); ?>" itemprop="thumbnail" alt="Image description" />
	                                            <div class="caption">
	                                                <h4>Portfolio Title</h4>
	                                                <p>is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy.</p>
	                                            </div>
	                                    ...
	                                    <figure class="col-xl-3 col-sm-6" itemprop="associatedMedia" itemscope="">
	                                        <a href="<?php echo e(asset('assets/images/big-lightgallry/08.jpg')); ?>" itemprop="contentUrl" data-size="1600x950">
	                                            <img src="<?php echo e(asset('assets/images/lightgallry/08.jpg')); ?>" itemprop="thumbnail" alt="Image description" />
	                                            <div class="caption">
	                                                <h4>Portfolio Title</h4>
	                                                <p>is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy.</p>
	                                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/apps/search.blade.php ENDPATH**/ ?>
			...
			<div class="col-xl-12 p-0">
	                <div class="login-card">
	                    <form class="theme-form login-form" method="post" action="/portal/auth">
	                        ...
	                        <p><a class="ms-2" href="#" target="_blank">Mwalimu Cormmecial Bank PLC</a></p>
	                    </form>
	                </div>
	            </div>
...
<?php echo $__env->make('admin.authentication.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/josephatwilliammadili/Desktop/UPDATED PROJECTS/EXTERNAL/MCB ESS/FRONT END/ESS-MCB-FRONTEND/resources/views/admin/authentication/login.blade.php ENDPATH**/ ?>